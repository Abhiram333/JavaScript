...
export function Person(props) {
  ...
  return (
    <div>
      ...
      <button onClick={OnEdit} id="clear">Edit</button>
...
export default function App() {
  ...
  return (
    <div>
       {showPerson?<Person person={person} setShowPerson={setShowPerson} />: <AddPerson person={person} setPerson={setPerson} setShowPerson={setShowPerson}/>}
